  ...
  const sections = [
    {
      ...
      p: t(
        'CCBONLINE INC. ("we", "us", or "our") respects your privacy. This Privacy Policy explains how we collect, use, and protect your personal information when you visit www.ccbonline.ca or contact us through our website.',
        'CCBONLINE INC.（"我们"）尊重您的隐私。本隐私政策说明我们在您访问 www.ccbonline.ca 或通过网站联系我们时如何收集、使用和保护您的个人信息。'
      ),
    },
    {
      ...
      p: t(
        ...
        '当您通过联系表单提交沟通时，我们收集：您的姓名、公司名称、邮箱地址、电话号码、产品或服务描述、目标市场目标、当前挑战以及您提供的任何附加留言。'
      ),
    },
    {
      ...
      p: t(
        ...
        '我们仅将您的信息用于回复您的沟通、评估我们的服务是否可以帮助您的企业，以及就可能的后续步骤与您沟通。未经您明确同意，我们不会将您的信息用于营销目的。'
      ),
    },
    {
      ...
      p: t(
        ...
        '我们不会出售、交易或与第三方分享您的个人信息。您的信息仅对参与回复您沟通的 CCBONLINE INC. 团队成员可访问。'
      ),
    },
    {
      ...
      p: t(
        ...
        '我们在必要的时间内保留您的联系信息，以回复您的沟通并维护业务记录。您可以随时通过 info@ccbonline.ca 要求删除您的信息。'
      ),
    },
    {
