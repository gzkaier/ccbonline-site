            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 md:p-12">
              {submitted ? (
                <div className="text-center py-16">
                  <div className="w-12 h-12 bg-[#00B894] rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <>
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto inline-flex items-center justify-center px-10 py-3.5 bg-[#00B894] text-white text-[14px] font-medium tracking-wide transition-all duration-400 hover:bg-[#A00000]"
