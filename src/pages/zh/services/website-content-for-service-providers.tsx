        ...
        <section className="relative pt-[100px] pb-[50px] md:pt-[140px] md:pb-[70px] bg-[#F8F9FA] overflow-hidden">
          ...
          <div className="container-site relative z-10">
            ...
            <p className="text-[#444] text-[15px] md:text-[17px] leading-[1.65] max-w-[720px] mb-6 md:mb-8">
              帮助本地专业服务商整理一个可被客户看懂、信任并愿意联系的线上入口。不只是做一个页面，而是把服务讲清楚、把信任建起来、把下一步路径设计好。
            </p>
          ...
          <div className="container-site max-w-[800px]">
            ...
            <div className="space-y-3 mb-10">
              {[
                ...
                { q: '这是建站服务吗？', a: '不只是建站。我们把重点放在内容梳理、服务表达和信任建设上。如果你已经有网站，我们可以在现有基础上优化内容；如果你需要建站，我们也能协调技术资源。核心是"把服务讲清楚"，而不是"做一个漂亮页面"。' },
