        ...
        <div className="container-site max-w-[800px]">
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-2 mt-3">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#C9A44C]">Seize the goods for auction or destruction</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#C9A44C]">Order the goods returned to the origin country at the shipper's expense</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#C9A44C]">Flag your company for future shipments, triggering additional inspections</li>
              </ul>
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/en/services/ior-import-responsibility" className="text-[14px] md:text-[15px] text-[#00A884] hover:underline">IOR & Import Responsibility Service →</Link></li>
              </ul>
            </div>
