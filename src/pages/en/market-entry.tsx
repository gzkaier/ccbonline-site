        ...
        <section className="section-padding bg-white">
          <div className="container-site max-w-[800px]">\n            <h2 className="font-serif text-[#212121] text-[22px] md:text-[26px] leading-[1.35] tracking-tight mb-6">
            ...
            <ul className="space-y-3 mb-10">
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">Chinese manufacturers with products ready for North American market consideration</li>
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">Companies that have tried entering North America before but encountered compliance, channel, or logistics setbacks</li>
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">Leadership teams needing a structured assessment before allocating significant budget to certification, travel, or distributor negotiations</li>
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">Businesses unsure whether Canada or the U.S. should be the first priority market</li>
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">Companies needing on-ground coordination support for trade shows, warehousing, or local operations</li>
            </ul>
            ...
            <div className="space-y-8 mb-10">
              <div className="p-5 md:p-6 border border-[#E5E5E5] bg-[#F8F9FA]">
                ...
                <ul className="space-y-2">
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Product-market fit screening against North American buyer expectations</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Canada vs. U.S. priority assessment based on your product category and compliance barriers</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Compliance and certification gap identification</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Target customer profile and channel direction</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">0-90 day action roadmap with prioritized sequence</li>
                </ul>
              </div>
              ...
              <div className="p-5 md:p-6 border border-[#E5E5E5] bg-[#F8F9FA]">
                ...
                <ul className="space-y-2">
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Buyer persona research for Canadian and U.S. markets</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Decision process mapping — who influences, who decides, who pays</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Channel pathway analysis — distributor, direct, specifier, or hybrid</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Competitive positioning review against existing market players</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Pilot outreach strategy with measurable validation criteria</li>
                </ul>
              </div>
              ...
              <div className="p-5 md:p-6 border border-[#E5E5E5] bg-[#F8F9FA]">
                ...
                <ul className="space-y-2">
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Product certification requirements (CSA, UL, cUL, FCC, Energy Star, etc.)</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Import licensing and customs documentation requirements</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Importer of Record (IOR) responsibility assignment</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Labeling, packaging, and language requirements</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Provincial and federal regulatory variations (Canada)</li>
                </ul>
              </div>
              ...
              <div className="p-5 md:p-6 border border-[#E5E5E5] bg-[#F8F9FA]">
                ...
                <ul className="space-y-2">
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Trade show preparation and on-site coordination</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Warehousing and 3PL provider evaluation</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Sample and demo unit logistics coordination</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Introduction to local service providers (legal, logistics, certification)</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Initial customer meeting preparation and follow-up support</li>
                </ul>
              </div>

              <div className="p-5 md:p-6 border border-[#E5E5E5] bg-[#F8F9FA]">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-[#D4AF37] text-[13px] font-medium">05</span>
                ...
                <ul className="space-y-2">
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Monthly strategy calls with structured agendas</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Market development priority assessment</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Partnership and distributor evaluation support</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Competitive intelligence and response planning</li>
                  <li className="text-[13px] text-[#555] leading-[1.6] pl-3 border-l border-[#00B894]">Operational issue escalation and coordination</li>
                </ul>
              </div>
            </div>
        ...
        <section className="section-padding bg-[#F8F9FA]">
          <div className="container-site max-w-[800px]">
            ...
            <ul className="space-y-2 mb-8">
              ...
              <li><Link to="/en/brand-credibility" className="text-[14px] md:text-[15px] text-[#00B894] hover:underline">Brand Credibility & Digital Infrastructure</Link></li>
