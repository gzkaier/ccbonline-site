          ...
          <div className="container-site max-w-[800px]">
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">已经完成<strong className="font-medium">市场判断和客户验证</strong>，准备开始实质性销售的企业</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">在北美<strong className="font-medium">没有本地员工或办公室</strong>，但需要有人协调样品、会议和物流的企业</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">与经销商或渠道方签订了意向，但<strong className="font-medium">需要本地支持来推进落地</strong>的企业</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">希望<strong className="font-medium">先以最小成本测试本地运营</strong>，再决定是否设立正式办公室的企业</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">经销商/渠道对接协调</strong> — 协助安排会议、传递资料、跟进合作条款进展、处理沟通中的信息缺口</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">样品管理与跟进</strong> — 协助样品在本地接收、转交、客户反馈收集和后续沟通</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">客户沟通支持</strong> — 在关键节点代你出面或协助沟通，确保客户感到被重视、响应及时</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">订单与物流协调</strong> — 协助跟进订单执行、物流状态、交付异常处理</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">本地事务信息节点</strong> — 作为你在北美本地的信息枢纽，收集市场动态、客户反馈和渠道动态，定期同步给你</li>
              </ul>
            </div>
            ...
            <div className="mb-12 p-5 md:p-6 bg-[#F8F9FA] border border-[#E5E5E5]">
              ...
              <p className="text-[15px] md:text-[16px] text-[#444] leading-[1.7]">
                如果验证结果积极，你可以考虑招聘本地代表或设立小型办公室；如果还需要时间观察，可以继续通过 <Link to="/zh/services/advisory-retainer" className="text-[#00B894] hover:underline">顾问式长期陪跑</Link> 获得持续支持。
              </p>
            </div>
