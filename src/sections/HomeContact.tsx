        ...
        <div className="cta-content max-w-[800px]">
          ...
          <div className="space-y-5 md:space-y-6 mb-8">
            <div className="flex gap-4 md:gap-5 items-start">
              <span className="text-[#00B894] text-[12px] font-bold min-w-[24px]">01</span>
              <div>
            ...
            <div className="flex gap-4 md:gap-5 items-start">
              <span className="text-[#00B894] text-[12px] font-bold min-w-[24px]">02</span>
              <div>
            ...
            <div className="flex gap-4 md:gap-5 items-start">
              <span className="text-[#00B894] text-[12px] font-bold min-w-[24px]">03</span>
              <div>
