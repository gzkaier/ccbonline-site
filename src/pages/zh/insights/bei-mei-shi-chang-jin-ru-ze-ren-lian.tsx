        ...
        <section className="section-padding bg-white">
          <div className="container-site max-w-[800px]">
            ...
            <p className="text-[15px] md:text-[16px] text-[#444] leading-[1.7] mb-10">
              企业进入北美时，关注点通常在产品质量和客户获取上。但一旦出现货被海关扣留、产品被要求召回、经销商失联的情况，核心问题就变成了：谁来负责？答案往往不清楚——因为进入市场之前，没有人梳理过责任链。进口记录责任人要承担海关处罚；认证持有方要对产品安全问题负责；经销商通常拒绝承担合规和召回责任；制造商往往是最后一个知道问题的人，却是声誉受损最大的一方。把责任链理清楚，不是为了打官司，而是为了让每个环节都有人管、出事有人应。
            </p>
            ...
            <ul className="space-y-3 mb-10">
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">为你的产品类别绘制完整的责任链</li>
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">检查经销合同中的责任缺口</li>
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">确定进口记录责任人和认证持有方</li>
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">在第一笔销售之前建立本地保修和服务方案</li>
              <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">联系 CCBONLINE 做责任链审计</li>
            </ul>
          </div>
        </section>
        ...
        <section className="section-padding bg-[#F8F9FA]">
          <div className="container-site max-w-[800px]">
            ...
            <ul className="space-y-2 mb-8">
              ...
              <li><Link to="/zh/insights/bei-mei-shi-chang-jin-ru-bu-shi-mai-huo" className="text-[14px] md:text-[15px] text-[#00B894] hover:underline">北美市场进入，不是把货卖出去</Link></li>
              <li><Link to="/zh/insights/ior-bu-shi-dai-qing-guan" className="text-[14px] md:text-[15px] text-[#00B894] hover:underline">进口记录责任人不是代清关的人</Link></li>
