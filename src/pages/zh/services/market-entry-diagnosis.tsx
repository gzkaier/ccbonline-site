          ...
          <div className="container-site max-w-[800px]">
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">考虑首次进入北美市场的中国制造企业或品牌方</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">不确定加拿大和美国哪个应该优先进入的管理层</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">需要在分配预算前进行结构化准备度评估的决策者</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">曾经尝试进入北美但遇到合规或渠道挫折、希望重新评估的企业</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">产品与市场适配度</strong> — 你的产品功能、定价、认证状态是否与北美主流买家需求匹配</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">加拿大 / 美国优先级判断</strong> — 基于你的产品类别、竞争格局、合规门槛和渠道特性，建议先进入哪个市场</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">合规与认证缺口筛查</strong> — 识别主要强制性认证、进口许可、标签要求和责任链前置条件</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">目标客户画像与渠道方向</strong> — 谁最可能购买、通过什么渠道采购、决策流程大概多长</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">现有资料与能力评估</strong> — 你的英文资料、产品文档、样品准备是否达到可展示标准</li>
              </ul>
            </div>
            ...
            <div className="mb-12 p-5 md:p-6 bg-[#F8F9FA] border border-[#E5E5E5]">
              ...
              <ul className="space-y-2 mb-4">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65]">• 如果诊断显示需要<strong className="font-medium">先验证客户和渠道</strong> → 进入 <Link to="/zh/services/customer-channel-validation" className="text-[#00B894] hover:underline">客户与渠道验证</Link></li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65]">• 如果诊断显示<strong className="font-medium">合规和责任链是最大缺口</strong> → 进入 <Link to="/zh/services/compliance-responsibility-chain" className="text-[#00B894] hover:underline">合规与责任链搭建</Link></li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65]">• 如果客户和渠道已初步验证、合规已梳理 → 直接进入 <Link to="/zh/services/local-execution-support" className="text-[#00B894] hover:underline">本地执行支持</Link> 或 <Link to="/zh/services/advisory-retainer" className="text-[#00B894] hover:underline">顾问式长期陪跑</Link></li>
              </ul>
