          ...
          <div className="container-site max-w-[800px]">
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">已有英文官网但搜索曝光几乎为零的中国制造商</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">担忧AI搜索趋势可能绕过传统SEO、需要提前布局GEO的B2B企业</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">希望在AI助手回答中被引用为信息源的企业</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]">理解数字 presence 是北美市场信任前提的进入期企业</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-3 mb-6">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">技术SEO审计</strong> — 网站结构、可抓取性、页面速度、移动端适配、索引问题的全面检查</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">关键词策略</strong> — 针对B2B采购意图的关键词研究，匹配你的产品品类和目标市场</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">页面优化</strong> — 标题标签、Meta描述、标题层级、内链结构和内容优化</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">内容架构</strong> — 按主题簇和支柱页面组织内容，让搜索引擎清晰理解你的业务结构</li>
              </ul>

              <h3 className="text-[17px] font-semibold mb-3 text-[#212121]">生成式引擎优化（GEO）</h3>
              <ul className="space-y-3">
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">AI可读性审计</strong> — 评估你的内容是否以AI系统能解析、理解、引用的方式组织</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">E-E-A-T信号强化</strong> — 提升Experience（经验）、Expertise（专业）、Authoritativeness（权威）、Trustworthiness（可信）四维信号</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">引用优化</strong> — 确保企业名称、资质、关键事实以AI易于引用的方式清晰呈现</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">结构化数据实施</strong> — Schema标记和结构化数据，帮助AI系统理解你的企业类型、地域和服务范围</li>
                <li className="text-[14px] md:text-[15px] text-[#444] leading-[1.65] pl-4 border-l-2 border-[#00B894]"><strong className="font-medium text-[#212121]">内容清晰度提升</strong> — 重写关键页面，减少歧义、提升事实精确度——这些都直接影响AI的理解和引用意愿</li>
              </ul>
            </div>
